        ...
        <div className="card-right">
          <div className="left">
            ...
            <p>
              ...
              specializing in the <b>MERN stack </b> (MongoDB, Express.js,
              React, Node.js). I love building dynamic, user-friendly web
        ...
        <div className="card-left">
          ...
          <div className="right">
            ...
            <p>
              ...
              learning the fundamentals of HTML, CSS, and JavaScript, I
              discovered the power of full-stack development — and since then,
              I've been crafting end-to-end applications using modern JavaScript
              technologies.
            </p>
          </div>
        </div>
